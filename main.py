...
with col1:
    text_input = st.text_area("Paste that update word salad below and activate AWARE WOLF...", height=200)
    context = "\n\n#### Please summarize this dense language into simple terms that ordinary people can understand, in 828 tokens, or less. ###"
...
with col2:
    submit = st.button("Activate AWARE WOLF!")
